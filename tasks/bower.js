...
module.exports = function(isProd, config) {
    ...
    return {
        getBowerCssTask: getBowerCssTask,
        getBowerFontsTask: getBowerFontsTask,
        getBowerImagesTask: getBowerImagesTask,
    };

    function getBowerCssTask() {
        ...
        return _getBowerCssTaskBody(src, dest, destFile);
    }
     ...
     * @return {Stream}
     */
    function _getBowerCssTaskBody(src, dest, destFile) {
     ...
     * @return {Stream}
     */
    function _getBowerFontsTaskBody(src, dest) {
    ...
    function getBowerImagesTask() {
        var src = config.bower.files.images;
        var dest = isProd ? config.dist.dir : config.dev.dir;

        // error handling for missing files

        return _getBowerImagesTaskBody(src, dest);
    }
     ...
     * @return {Stream}
     */
    function _getBowerImagesTaskBody(src, dest) {
